...
| `PLOT_INTERMEDIATE`<br/>*`--plot`*           | Default plotting mode<br/>**Valid values:**<table><tbody><tr><td>`0` / `none`</td><td>none</td></tr><tr><td>`1` / `all`</td><td>none</td></tr><tr><td>`L1`</td><td>L1 Dynamic Brightness</td></tr><tr><td>`L2[_NITS]`</td><td>L2 Trims</td></tr><tr><td>`L8T[_NITS]`</td><td>L8 Trims</td></tr><tr><td>`L8S[_NITS]`</td><td>L8 Saturation Vectors</td></tr><tr><td>`L8H[_NITS]`</td><td>L8 Hue Vectors</td></tr></tbody></table>`NITS` = 100 *(default)*, 600, 1000 or MAX | *\<comma-separated list>*<br/>**Default:** `L1,L2,L2_MAX,L8T`                                        |
