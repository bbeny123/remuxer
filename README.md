...
| `FELBAKER_PATH`                                       | Absolute path to `FelBaker` **VS plugin**<br/>**Empty**: **VS** auto-detection                                                                                                                                                                                                                                                                                                                                                                                                                                                      | *\<abosulte path>*<br/>**Default:** `felbaker.dll`                                                                                                                                                                                            |
| `FFMS2_PATH`                                          | Absolute path to `FFMS2` **VS plugin**<br/>**Empty**: **VS** auto-detection                                                                                                                                                                                                                                                                                                                                                                                                                                                         | *\<abosulte path>*<br/>**Default:** `ffms2.dll`                                                                                                                                                                                               |
| `FFMS2_THREADS`                                       | Number of `FFMS2` decoding threads                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | *\<threads number>*<br/>**Default:** `4`                                                                                                                                                                                                      |
